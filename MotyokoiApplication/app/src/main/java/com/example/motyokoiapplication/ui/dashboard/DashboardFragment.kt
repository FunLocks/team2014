    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
       ...
       // super.onViewCreated(view, savedInstanceState)
        var UserList = arrayListOf<User>(
                User("伊藤　清英","itokiyo@fun.ac.jp","3階 325室",R.drawable.yes_room),
                ...
                User("川口　聡","satoshi@fun.ac.jp","2階 234室",R.drawable.no_room),
                User("川越　敏司","kawagoe@fun.ac.jp","4階 424室",R.drawable.no_room),
                User("川嶋　稔夫","kawashima@fun.ac.jp","研究棟1階 603室",R.drawable.no_room),
                User("姜　南圭","kang@fun.ac.jp","2階 231室",R.drawable.no_room),
                User("木村　健一","kimura@fun.ac.jp","1階 131室",R.drawable.no_room),
                User("齊藤　朝輝","saito@fun.ac.jp","研究棟1階 654室",R.drawable.no_room),
                User("櫻沢　繁","sakura@fun.ac.jp","3階 334室",R.drawable.no_room),
                User("佐々木　博昭","hsasaki@fun.ac.jp","4階 431室",R.drawable.no_room),
                User("佐藤　生馬","ikuma-is@fun.ac.jp","2階 230室",R.drawable.no_room),
                User("佐藤　直行","satonao@fun.ac.jp","2階 235室",R.drawable.no_room),
                User("佐藤　仁樹","jamisato@fun.ac.jp","3階 323室",R.drawable.no_room),
                User("姜　暁鴻","jiang@fun.ac.jp","2階 226室",R.drawable.no_room),
                ...
                User("角　康之","sumi@fun.ac.jp","1階 126室",R.drawable.no_room),
                ...
                User("竹川　佳成","yoshi@fun.ac.jp","1階 125室",R.drawable.no_room),
                User("竹之内　高志","ttakashi@fun.ac.jp","4階 435室",R.drawable.no_room),
                User("田中　吉太郎","y-tanaka@fun.ac.jp","4階 434室",R.drawable.no_room),
                ...
                User("寺井　あすか","aterai@fun.ac.jp","1階 130室",R.drawable.no_room),
                User("寺沢　憲吾","kterasaw@fun.ac.jp","4階 423室",R.drawable.no_room),
                User("富永　敦子","tominaga@fun.ac.jp","5階 525室",R.drawable.no_room),
                User("中小路　久美代","kumiyo@fun.ac.jp","4階 429室",R.drawable.no_room),
                User("長崎　健","nagasaki@fun.ac.jp","研究棟1階 601室",R.drawable.no_room),
                User("中田　隆行","nakata@fun.ac.jp","3階 327室",R.drawable.no_room),
                User("中村　美智子","m-naka@fun.ac.jp","5階 524室",R.drawable.no_room),
                User("中村　嘉隆","y-nakamr@fun.ac.jp","2階 228室",R.drawable.no_room),
                ...
                User("原田　泰","haraday@fun.ac.jp","3階 331室",R.drawable.no_room),
                User("平田　圭二","hirata@fun.ac.jp","1階 123室",R.drawable.no_room),
                User("藤野　雄一","fujino@fun.ac.jp","2階 224室",R.drawable.no_room),
                User("フランク・イアン","ianf@fun.ac.jp","研究棟1階 611室",R.drawable.no_room),
